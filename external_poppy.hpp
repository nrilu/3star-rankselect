...
class external_poppy : public Bitvector {
...
public:
	...
	void build_auxiliaries() override {
		cout << "Starting Poppy Bit reversing" << endl;
	...
	uint64_t select_0(int64_t k) const override {
		cout << "select_0: not supported by poppy" << endl;
		return 0;
	}
